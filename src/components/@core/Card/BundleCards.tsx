...
export default function BundleCard({ title, price, benefits, id }: BundleCardProps) {
    ...
    const {wallet, getBalance, sendETH} = useWallet();
    ...
    const buy = (async() =>{
        ...
        // await DaoTrainingService.buy(id, Number(price), Number(balance));
        // const wallet = sessionStorage.getItem("DaoTestWallet");
        // console.log(wallet);
       // const tx =  await sendETH("0x934c7188957da61f12ef3541b3b8728d991277244ea507b6f1b243e42d0a69bb", price,"password" );
       // console.log(tx);
    ...
    return (
        <>
            <div className="w-[250px] h-[300px] bg-gradient-to-b from-[#0c2539] to-[#11314a] rounded-2xl shadow-lg p-4 border border-[#1e3a57] hover:scale-105 hover:overflow-visible transition-transform duration-200 flex flex-col">
                ...
                <p className="text-[25px] font-bold text-white text-center mb-4">{price} $</p>
            ...
            <PaymentCard txId={12345} dueValue={50} display={showModal}/>
        </>
